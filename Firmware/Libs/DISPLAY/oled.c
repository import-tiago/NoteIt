...
const uint8_t Font1612[11][32] = { { 0x00,
                                     0x00,
                                     0x3F,
                                     0xFC,
                                     0x3F,
...
const uint8_t Font1206[95][12] = { { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/*" ",0*/
...
const uint8_t Font1608[95][16] = { { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/*" ",0*/
...
const uint8_t Font3216[11][64] = { { 0x00,
                                     0x00,
                                     0x00,
                                     0x00,
                                     0x00,
...
const uint8_t Waveshare12864[1024] = { 0x00,
                                       0x00,
                                       0x00,
                                       0x00,
                                       0x00,
...
void SSD1306_char(unsigned char x, unsigned char y, char acsii, char size, char mode, uint8_t *buffer) {
    ...
    for (i = 0; i < size; i++) {
        ...
        for (j = 0; j < 8; j++) {
            if (temp & 0x80)
                SSD1306_pixel(x, y, 1, buffer);
            else
                SSD1306_pixel(x, y, 0, buffer);
            temp <<= 1;
            y++;
            if ((y - y0) == size) {
                y = y0;
